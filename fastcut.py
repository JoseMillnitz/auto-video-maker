...
parser.add_argument('--frame_rate', type=float, default=25, help="frame rate of the input and output videos. optional... I try to find it out myself, but it doesn't always work.")
